    ...
    <div className="flex flex-col items-center justify-center">
      ...
      >
        ...
        <header className="px-6 py-4 flex flex-col justify-center items-center">
          ...
          <h2
            ref={counterHTMLElement}
            className="text-2xl font-bold text-center mb-4 text-neutral-950 bg-neutral-100 rounded-full py-2.5 px-5"
          >
            {count}
          </h2>
      ...
      <div
        className={`animate-fade-up animate-duration-300 animate-ease-out ${className}`}
      >
        <h2 className="text-2xl font-normal text-center mt-10">State</h2>

        <pre className="bg-neutral-800 text-neutral-100 p-4 rounded-lg mt-4">
